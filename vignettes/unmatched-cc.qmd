...
- `estimator = "logistic"` — logistic regression
  ...
  type. Because case-control sampling shifts only the intercept
  [@prentice1979logistic], the slope ORs equal the source-population ORs.
...
oesophageal cancer [@breslow1980statistical], stored as per-cell case / control
...
The reported interval is the Robins-Breslow-Greenland variance
[@robins1986estimators], valid in both the sparse-data and large-stratum limits. The MH estimator needs a 2×2
