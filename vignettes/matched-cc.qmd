...
converges to the *squared* OR [@breslow1980statistical] — so matchatr never does
that.
...
odds ratio is `OR = n10 / n01` with `Var(log OR) = 1/n10 + 1/n01`
[@mcnemar1947note]. Pairs concordant on exposure carry no information and cancel.
