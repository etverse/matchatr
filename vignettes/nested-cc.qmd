...
`survival::coxph` with the Langholz-Borgan log-weights as an offset (the
unweighted clogit is biased for this design):
...
Langholz B, Borgan Ø (1995). Counter-matching: a stratified nested case-control
